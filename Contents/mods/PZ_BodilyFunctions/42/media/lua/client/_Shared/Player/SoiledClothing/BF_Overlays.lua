...
BF_Overlays.soilableBodyLocations = {"UnderwearBottom", "Underwear", "Torso1Legs1", "Legs1", "Pants", "BathRobe", "FullSuit", "FullSuitHead", "FullTop", "BodyCostume", "ShortPants", "ShortsShort"}
...
Trousers = {
    ...
    overlays = {
        pee = generateOverlayStates("BF.Trousers_Peed", false),
...
SuitTrousersMesh = {
    ...
    overlays = {
        pee = generateOverlayStates("BF.SuitTrousersMesh_Peed", false),
...
MaleUnderwear = {
    ...
    overlays = {
        pee = generateOverlayStates("BF.Male_Boxers_Peed", false),
...
FemaleUnderwear = {
    ...
    overlays = {
        pee = generateOverlayStates("BF.Female_Underpants_Peed", false),
...
LongShorts = {
    ...
    overlays = {
        pee = generateOverlayStates("BF.LongShorts_Peed", false),
...
BoxingShorts = {
    ...
    overlays = {
        pee = generateOverlayStates("BF.BoxingShorts_Peed", false),
...
ShortShorts = {
    ...
    overlays = {
        pee = generateOverlayStates("BF.ShortShorts_Peed", false),
