...
BF_ClothingConfig = {
    ...
    clothingModels = {
        ...
        ShortShorts = {
            ...
            peeOverlay = "BathroomFunctions.ShortShorts_Peed",
            poopOverlay = "BathroomFunctions.ShortShorts_Pooped"
        }
    }
}